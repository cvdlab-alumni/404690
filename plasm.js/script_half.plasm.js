...
var Curbe = function () {
    ...
    return half_curbe.color(Colors.walls);
};
...
var Front = function () {
    ...
    return STRUCT([front_arc, half_front]);
};
...
var Entrance_Wall = function () {
    ...
    return STRUCT([d_2,half_entrance]);
};
